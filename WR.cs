...
namespace TestProject1
{
    public class WR : Player
    {
        ...
        public WR(int catches, int yards, int yards_after_catch, int touchdowns, int fumbles, int fantasy_Points, string name, string position, string age, int number, string height, int weight, string college, string accolades)

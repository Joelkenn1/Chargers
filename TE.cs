...
namespace TestProject1
{
    public class TE : Player
    {
        ...
        public TE(int catches, int yards, int yards_after_catch, int touchdowns, int targets, int fumbles, int fantasy_Points, string name, int age, int number, int height, int weight, int minutesplayed, string college)

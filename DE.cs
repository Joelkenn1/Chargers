...
namespace TestProject1
{
    public class DE : Player
    {
        ...
        public DE(int tackels, int tackle_Assists, int fumbles_Caused, int fumble_Recoveries, int sacks, string name, string position, string age, int number, string height, int weight, string college, string accolades)
